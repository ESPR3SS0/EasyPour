...
```bash
python -m easypour.cli --builder examples/simple/builder.py --md examples/out/simple.md
```
...
```
```bash
python -m easypour.cli --builder examples/complex/builder.py --md examples/out/complex.md
```
...
```python
"""Streamlit example for EasyPour.
...
from easypour.core import Report, Table, Image
...
if __name__ == "__main__":
    ...
    try:
        ...
        st.set_page_config(page_title="EasyPour + Streamlit", layout="wide")
        st.title("EasyPour + Streamlit")
