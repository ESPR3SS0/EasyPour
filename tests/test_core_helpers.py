...
core = import_module("mochaflow.core")
...
underline = getattr(core, "underline", None) or getattr(core, "u")
code = getattr(core, "code")
url = getattr(core, "url", None) or getattr(core, "link")
