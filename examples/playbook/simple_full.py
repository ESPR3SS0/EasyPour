"""Simple end-to-end MochaFlow example.
...
def build_report() -> Report:
    rpt = Report("Quarterly Snapshot", author="MochaFlow Examples")
    summary = rpt.add_section("Summary")
    summary.add_text(
        "This lightweight report demonstrates the MochaFlow workflow.",
...
def main():
    parser = argparse.ArgumentParser(description="Simple MochaFlow workflow example.")
