"""Advanced Dash example for MochaFlow.
...
- Builds a MochaFlow Report and renders HTML in an iframe
...
app = Dash(__name__)
app.title = "MochaFlow + Dash (Advanced)"

app.layout = html.Div(
    [
        html.H1("MochaFlow + Dash (Advanced)"),
        html.Div(
            [
                html.Div(
                    [
