"""Complex PDF export example for EasyPour.
...
def build_report() -> Report:
    ...
    rpt.add_section("Executive Summary").add_text(
        ...
        "It demonstrates EasyPour's ability to export a nicely formatted PDF from",
    ...
    img_path = _maybe_matplotlib_plot(_ROOT / ".easypour_figs")
    if img_path:
